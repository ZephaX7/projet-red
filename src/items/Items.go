...
func PoisonPot(target *model.Personnage, inventaire *[]inventory.Objet) {
	for i := 1; i <= 3; i++ {
		damage := 10
...
func UtiliserObjet(nom string, perso *model.Personnage, inventaire *[]inventory.Objet, target *model.Personnage, inCombat bool) {
